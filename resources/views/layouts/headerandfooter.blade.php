...
<body>
    ...
    <div class="layout-wrapper">
        ...
        <div class="main-menu">
            ...
            <div class="logo-box">
                ...
                <a class='logo-light' href='index.html'>
                     <h3 class="logo-lg"style='color:#cedce4;'>Saqline zaman</h3>
        ...
        <div class="page-content">
                    ...
                    <ul class="topbar-menu d-flex align-items-center gap-4">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                                ...
                                <!-- item-->
                                {{-- log out e obosshoi form tag bebojar korte hobe boro vai 😊😊 --}}
                                <form action="{{route('logout')}}" method="POST">

                                    {{-- @csrf bebohar na korle tumi akta kissing error khaba inshallah 😘😘 --}}
            ...
            {{-- connect header and footer with yield .  --}}

            @yield('content')
            {{-- without this @yield  i can't connect 😘😘 latter he will give you an error kiss --}}
